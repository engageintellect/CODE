...
try:
    ...
    os.system('cd /home/r3dux/.config/transmission/torrents && sudo rm *')
    os.system('cd /home/r3dux/.config/transmission/resume && sudo rm *')
except:
...
if dev_input == 'q':
    ...
    dd_cmd = f'sudo dd if=/home/r3dux/downloads/{iso_file} of={dev_input} bs=4M status=progress; sync'
    os.system(dd_cmd)
